...
audio_button = KeyboardButton("Аудио")
...
async def start(message: types.Message):
    await message.answer(f"""Здраствуйте, {message.from_user.full_name} Я вам помогу скачать аудио или же видео с ютуба""", reply_markup= buttons)
...
async def not_found(message: types.Message):
    await message.reply("Я вас не понял",reply_markup=buttons)
